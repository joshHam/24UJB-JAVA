...
public class CheckboxTest {
	...
	public static void main(String[] args) {
		...
		CheckboxGroup group1 = new CheckboxGroup();		//라디오버튼으로 만들어줌
		Checkbox movie1 = new Checkbox("한 달에 한 번 갑니다.",group1,true);
		Checkbox movie2 = new Checkbox("일주일에에 한 번 갑니다.",group1,true);
		...
		Checkbox com1 = new Checkbox("5시간 이하",group1,true);
		Checkbox com2 = new Checkbox("10시간 이하",group1,false);
		Checkbox com3 = new Checkbox("15시간 이상",group1,false);
		f.add(q3);
		f.add(com1);
		f.add(com2);
		f.add(com3);
